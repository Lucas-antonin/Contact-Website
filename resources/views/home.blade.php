...
<div class="main-banner header-text" id="top">
    <div class="Modern-Slider">
        ...
        <div class="item">
            <div class="img-fill">
                <img src="{{ asset('images/slide-01.jpg') }}">
        ...
        <div class="item">
            <div class="img-fill">
                <img src="{{ asset('images/slide-02.jpg') }}">
                <div class="text-content">
        ...
        <div class="item">
            <div class="img-fill">
                <img src="{{ asset('images/slide-03.jpg') }}">
                <div class="text-content">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6">
                            <div class="service-item">
                                <img src="{{ asset('images/service-item-01.png') }}">
                                <h4>Top Notch</h4>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="service-item">
                                <img src="{{ asset('images/contact-info-03.png') }}">
                                <h4>Reliable</h4>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                <div class="features-item">
                    <div class="features-icon">
                        <img src="{{ asset('images/features-icon-1.png') }}">
                    </div>
                ...
                <div class="filters-content">
                    <div class="row grid">
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 all des">
                            <div class="item">
                                <a href="../../public/images/project-big-item-01.jpg" data-lightbox="image-1" data-title="Our Projects"><img src="../../public/images/project-item-01.jpg" alt=""></a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 all dev">
                            <div class="item">
                                <a href="../../public/images/project-big-item-02.jpg" data-lightbox="image-1" data-title="Our Projects"><img src="../../public/images/project-item-02.jpg" alt=""></a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 all gra">
                            <div class="item">
                                <a href="../../public/images/project-big-item-03.jpg" data-lightbox="image-1" data-title="Our Projects"><img src="../../public/images/project-item-03.jpg" alt=""></a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 all tsh">
                            <div class="item">
                                <a href="../../public/images/project-big-item-04.jpg" data-lightbox="image-1" data-title="Our Projects"><img src="../../public/images/project-item-04.jpg" alt=""></a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 all dev">
                            <div class="item">
                                <a href="../../public/images/project-big-item-05.jpg" data-lightbox="image-1" data-title="Our Projects"><img src="../../public/images/project-item-05.jpg" alt=""></a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 all des">
                            <div class="item">
                                <a href="../../public/images/project-big-item-06.jpg" data-lightbox="image-1" data-title="Our Projects"><img src="../../public/images/project-item-06.jpg" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 mobile-bottom-fix-big" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                <div class="owl-carousel owl-theme">
                    ...
                    <div class="item author-item">
                        <div class="member-thumb">
                            <img src="{{ asset('images/member-item-02.jpg') }}">
                            <div class="hover-effect">
                                <div class="hover-content">
                                    <ul>
                                        <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                    ...
                    <div class="item author-item">
                        <div class="member-thumb">
                            <img src="{{ asset('images/member-item-03.jpg') }}">
                            <div class="hover-effect">
                                <div class="hover-content">
                                    <ul>
                                        <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                    ...
                    <div class="item author-item">
                        <div class="member-thumb">
                            <img src="{{ asset('images/member-item-04.jpg') }}">
                            <div class="hover-effect">
                                <div class="hover-content">
                                    <ul>
                                        <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                    ...
                    <div class="item author-item">
                        <div class="member-thumb">
                            <img src="{{ asset('images/member-item-05.jpg') }}">
                            <div class="hover-effect">
                                <div class="hover-content">
                                    <ul>
                                        <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                    ...
                    <div class="item author-item">
                        <div class="member-thumb">
                            <img src="{{ asset('images/member-item-06.jpg') }}">
                            <div class="hover-effect">
                                <div class="hover-content">
                                    <ul>
                                        <li><a href="#"><i class="fa fa-facebook"></i></a></li>
            ...
            <div class="col-lg-4 col-md-4 col-xs-12">
                <div class="left-text-content">
                    ...
                    <ul class="contact-info">
                        <li><img src="{{ asset('images/contact-info-01.png') }}">010-020-0860</li>
                        <li><img src="{{ asset('images/contact-info-02.png') }}">info@company.com</li>
                        <li><img src="{{ asset('images/contact-info-03.png') }}">www.company.com</li>
                    </ul>
                </div>
            </div>
